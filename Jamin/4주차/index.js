...
const commentItemTemplate = (newComment) => {
    ...
    <li class = "commentItems">
        <img src = "https://yt3.ggpht.com/yti/APfAmoENI_pag5nUdXzjvpmAgvHAJpWaBzg8zbKwTAsMBw=s88-c-k-c0x00ffffff-no-rj" class = "profileImg"/>
        <div>
            <P id = "commentName">Park Jae Min</P>
            <p>$(newComment)</p>
            <div class="flex">
